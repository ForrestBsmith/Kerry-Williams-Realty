      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card property-card border-0 shadow-sm h-100">
          ...
          <div class="position-relative">
            <img src="${prop.image}" class="card-img-top object-fit-cover" alt="${prop.address}" style="height: 220px; border-top-left-radius: .5rem; border-top-right-radius: .5rem;">
          ...
          <div class="card-body">
            <!-- Price -->
            <h5 class="card-title fw-bold mb-2">$${prop.price.toLocaleString()}</h5>

            <!-- Address -->
            <p class="text-muted small mb-2">${prop.address}, ${prop.city}, TX ${prop.zip}</p>

            <!-- Specs Row -->
            <div class="d-flex justify-content-between text-secondary small mb-2">
              <div><i class="bi bi-house-door"></i> ${prop.bedrooms} Beds</div>
              <div><i class="bi bi-bucket"></i> ${prop.bathrooms} Baths</div>
              <div><i class="bi bi-aspect-ratio"></i> ${prop.squareFeet?.toLocaleString() || 'N/A'} SqFt</div>
            </div>

            <div class="text-muted" style="font-size:13px;">${prop.description || ''}</div>
    ...
    document.querySelector("#photosModalBody").innerHTML = `
      <div id="carousel-${index}" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ${(prop.images || [prop.image]).map((img, i) => `
...
/* === Optional: Initial Example Properties for quick testing (remove if using JSON) === */
// const properties = [
//   { address: "123 Main St", price: 450000, lat: 31.6131, lng: -97.3295, city: "SomeCity", bedrooms: 3, bathrooms: 2, squareFeet: 1800, description: "Nice home", listedDaysAgo: 5 },
//   { address: "456 Oak Ave", price: 350000, lat: 31.4496, lng: -97.1920, city: "OtherCity", bedrooms: 2, bathrooms: 1, squareFeet: 1400, description: "Cozy place", listedDaysAgo: 10 }
// ];
